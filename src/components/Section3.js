...
const Section3 = () => {
    ...
    return (
        ...
        <div className="row bg-black text-white">
            ...
            <div className="bg-black bg-dark-hover text-secondary my-4 section3-card px-2 py-2" onClick={() => handleCardClick(0)}>
                ...
                <div className="bg-black text-secondary my-4 section3-card px-2 py-2" onClick={() => handleCardClick(1)}>
                    <span className="d-flex align-items-center">
                        <AiOutlineLogout className="fs-3 me-2" />
                ...
                <div className="bg-black text-secondary my-4 section3-card px-2 py-2" onClick={() => handleCardClick(2)}>
                    <span className="d-flex align-items-center">
                        <AiOutlineLogout className="fs-3 me-2" />
                    ...
                    <p className="fs-6">
                        ...
                        tool for businesses, organizations, and inbuttoniduals who want to increase <br />
                        efficiency and productivity.
                    </p>
                </div>
                <div className="bg-black text-secondary my-4 section3-card px-2 py-2" onClick={() => handleCardClick(3)}>
                    <span className="d-flex align-items-center">
                        <AiOutlineLogout className="fs-3 me-2" />
                ...
                <div className="bg-black text-secondary my-4 section3-card px-2 py-2" onClick={() => handleCardClick(4)}>
                    <span className="d-flex align-items-center">
                        <AiOutlineLogout className="fs-3 me-2" />
                ...
                <div className="bg-black text-secondary my-4 section3-card px-2 py-2" onClick={() => handleCardClick(5)}>
                    <span className="d-flex align-items-center">
                        <AiOutlineLogout className="fs-3 me-2" />
